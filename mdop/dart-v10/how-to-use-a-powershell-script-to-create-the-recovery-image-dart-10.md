...
ms.locfileid: "10822813"
---
# <span data-ttu-id="9f169-103">PowerShell 스크립트를 사용하여 복구 이미지를 만드는 방법</span><span class="sxs-lookup"><span data-stu-id="9f169-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="9f169-104">PowerShell 스크립트를 사용 하 여 DaRT 복구 이미지를 만들려면</span><span class="sxs-lookup"><span data-stu-id="9f169-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="9f169-105">DaRT 10 복구 이미지 마법사를 사용 하는 대신 PowerShell 스크립트를 사용 하 여 Microsoft 진단 및 복구 도구 집합 (DaRT) 10 복구 이미지를 만들 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="9f169-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="9f169-106">다음 예제 스크립트를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="9f169-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="9f169-107">칼럼</span><span class="sxs-lookup"><span data-stu-id="9f169-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="9f169-108">관련 항목</span><span class="sxs-lookup"><span data-stu-id="9f169-108">Related topics</span></span>


[<span data-ttu-id="9f169-109">PowerShell을 사용하여 DaRT 10 관리</span><span class="sxs-lookup"><span data-stu-id="9f169-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
