...
---
# PowerShell 스크립트를 사용하여 복구 이미지를 만드는 방법


## <a href="" id="bkmk-create-image-use-script"></a>PowerShell 스크립트를 사용 하 여 DaRT 복구 이미지를 만들려면


DaRT 10 복구 이미지 마법사를 사용 하는 대신 PowerShell 스크립트를 사용 하 여 Microsoft 진단 및 복구 도구 집합 (DaRT) 10 복구 이미지를 만들 수 있습니다. 다음 예제 스크립트를 참조 하세요.
...
`Import-Module "Dism"`칼럼`mport-Module "Microsoft.Dart"`
