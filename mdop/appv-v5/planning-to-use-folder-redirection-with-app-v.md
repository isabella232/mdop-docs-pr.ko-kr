...
App-v 5.0 SP2는 사용자와 관리자가 폴더 경로를 새 위치로 리디렉션할 수 있도록 하는 폴더 리디렉션 사용을 지원 합니다.
...
<tr class="even">
<td align="left"><p>앱-V 5.0 SP3</p></td>
...
<p>중복성을 제공 하기 위해 App-v 5.0는 압축 된 데이터의 가장 최근 복사본 3 개 를% AppData%로 유지 합니다.</p></td>
</tr>
</tbody>
</table>
