...
Microsoft Application Virtualization (App-v) 5.1 이상 버전을 사용 하 여 조직의 컴퓨터에 Microsoft Office 2013을 가상화 된 응용 프로그램으로 제공 하려면이 문서의 정보를 사용 합니다. Office 2010를 제공 하기 위해 App-v를 사용 하는 방법에 대 한 자세한 내용은 [app-v를 사용 하 여 Microsoft Office 2010 배포](deploying-microsoft-office-2010-by-using-app-v51.md)를 참조 하세요. App-v를 사용 하 여 Office 2013를 성공적으로 배포 하려면 Office 2013 및 App-v에 대해 잘 알고 있어야 합니다.
...
-   [앱에 대 한 Office 패키지 게시-V 5.1](#bkmk-pub-pkg-office)
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="planning-for-using-app-v-with-office51.md#bkmk-office-vers-supp-appv" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office51.md#bkmk-office-vers-supp-appv)">Office와 App-V 사용 계획</a></p></td>
<td align="left"><ul>
...
<tr class="even">
<td align="left"><p><a href="planning-for-using-app-v-with-office51.md#bkmk-plan-coexisting" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office51.md#bkmk-plan-coexisting)">Office와 App-V 사용 계획</a></p></td>
...
<li><p>App-v 5.1 이상에서는 Office 배포 도구를 사용 하 여 패키지를 만들어야 합니다. Sequencer는 사용할 수 없습니다.</p></li>
...
App-v 5.1 이상 버전의 Office 2013 패키지를 만들려면 다음 단계를 완료 하세요.

**중요**  
App-v 5.1 이상에서는 패키지를 만들기 위한 Office 배포 도구가 필요 합니다. Sequencer를 사용 하 여 패키지를 만들 수는 없습니다.
...
<td align="left"><ul>
<li><p>64 비트 버전의 Windows 8 이상</p></li>
...
64 비트 Windows 컴퓨터에서 Office 2013 앱-V 패키지를 만듭니다. Office 2013 앱-V 패키지는 일단 만들어지면 32 비트 및 64 비트 Windows 7, Windows 8.1 및 Windows 10 컴퓨터에서 실행 됩니다.
...
-   64 비트 Windows 컴퓨터에서 Office 2013 앱-V 패키지를 만듭니다. 그러나 패키지는 32 비트 및 64 비트 Windows 7, Windows 8 및 Windows 10 컴퓨터에서 실행 됩니다.
...
## <a href="" id="bkmk-pub-pkg-office"></a>앱에 대 한 Office 패키지 게시-V 5.1
...
2.  App-v 5.1 Sequencer를 사용 하 여 플러그 인을 시퀀싱 합니다. 플러그 인을 시퀀싱 하는 데 사용 되는 컴퓨터에 Office 2013이 설치 되어 있는지 확인 합니다. Office 2013 플러그 인을 순서 대로 시퀀싱 하는 컴퓨터에서 Microsoft 365 앱 (비가상)을 사용 하는 것이 좋습니다.

3.  원하는 플러그 인을 포함 하는 App-v 5.1 패키지를 만듭니다.
