...
App-v 5.0 패키지를 게시 하려면 다음 절차를 사용 합니다. 패키지를 게시 하면 App-v 5.0 클라이언트를 실행 하는 컴퓨터에서 해당 패키지의 응용 프로그램에 액세스 하 고 실행할 수 있습니다.
...
1.  앱-V 5.0 관리 콘솔에서 게시할 패키지의 이름을 마우스 오른쪽 단추로 클릭 하 고 **게시**를 선택 합니다.
