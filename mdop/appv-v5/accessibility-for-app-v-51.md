...
## App-v 5.1 관리 서버의 바로 가기 키


다음은 App-v 5.1 관리 서버의 바로 가기 키입니다.
...
<tbody>
<tr class="odd">
<td align="left"><p>대화 상자를 닫습니다.</p></td>
<td align="left"><p>Esc</p></td>
</tr>
<tr class="even">
<td align="left"><p>대화 상자의 기본 동작을 수행 합니다.</p></td>
<td align="left"><p>Enter</p></td>
</tr>
<tr class="odd">
<td align="left"><p>App-v 5.1 클라이언트 콘솔의 현재 페이지를 새로 고칩니다.</p></td>
...
## App-V 5.1 시퀀서의 바로 가기 키


다음은 App-v 5.1 Sequencer에서 패키지 편집기의 가상 레지스트리 탭에 대 한 바로 가기 키입니다.
...
<tbody>
<tr class="odd">
<td align="left"><p>찾기 대화 상자를 엽니다.</p></td>
<td align="left"><p>CTRL + F</p></td>
</tr>
<tr class="even">
<td align="left"><p>바꾸기 대화 상자를 엽니다.</p></td>
...
**중요**  이 섹션의 정보는 App-v 5.1 시퀀서에만 적용 됩니다. App-v 5.1 서버에 대 한 자세한 내용은이 문서의 App-V 5.1 관리 서버 섹션에 대 한 바로 가기 키를 참조 하세요.
...
1.  ALT 키를 누릅니다.
    ...
    현재 보기에서 사용할 수 있는 각 기능에 대 한 바로 가기 키 아래에 밑줄이 표시 됩니다.

2.  사용할 기능의 바로 가기 키에서 밑줄이 그어진 글자를 누릅니다.
