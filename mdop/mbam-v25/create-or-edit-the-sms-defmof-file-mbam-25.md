...
SystemCenter2012 ConfigurationManager를 사용 하는 경우에는 파일을 만들어야 합니다. 최상위 계층 사이트에서 파일을 만듭니다. 변경 내용이 인프라의 다른 사이트에 복제 됩니다.
...
3.  **Win32 \ _Tpm** 클래스를 다음과 같이 수정 합니다.
    ...
    **MBAM에 대 한 제안이 있으십니까**? [여기](http://mbam.uservoice.com/forums/268571-microsoft-bitlocker-administration-and-monitoring)에서 제안을 추가 하거나 투표 합니다. **MBAM 문제가 발생 하셨나요**? [Mbam TechNet 포럼](https://social.technet.microsoft.com/Forums/home?forum=mdopmbam)을 사용 합니다.
